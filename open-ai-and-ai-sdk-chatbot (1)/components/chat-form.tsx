...
export function ChatForm({ className, ...props }: React.ComponentProps<"form">) {
  ...
  const header = (
    <header className="m-auto flex max-w-96 flex-col gap-5 text-center">
      <h1 className="text-2xl font-semibold leading-none tracking-tight">AuraSpeed Project Assistant AI</h1>
      <p className="text-muted-foreground text-sm">
        This AI is capable of handling your video scripts <span className="text-foreground">Next.js</span>, Thumbnails{" "}
        <span className="text-foreground">ideas generating</span>, and <span className="text-foreground">content research and keyword research</span>.
      </p>
      <p className="text-muted-foreground text-sm">
